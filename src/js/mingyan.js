...
export let getNowId = function () {
    ...
    return /#\d/.test(location.hash) ? location.hash.split("#")[1] : window["nowId"]
}
...
export let formatMingyan = function (id) {
    ...
    let text = _my.split("：")[1] + (_my.split("：")[2] ? "：" : "") + (_my.split("：")[2] || "");
    return { teacher, text }
}

window["mingyan"] = mingyan;
window["nowId"] = window["nowId"] || kv.get(kvName.mingyanId) || 0;